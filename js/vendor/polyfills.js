(function (global, factory) {
    ...
    function getNextElementSnapPoint(scrollObj, obj, direction) {
        ...
        if ((left > 0 && (left + getWidth(scrollObj)) === getScrollWidth(scrollObj)) || (top > 0 && (top + getHeight(scrollObj)) === getScrollHeight(scrollObj))) {
            ...
            return {
                y: stayInBounds(0, getScrollHeight(scrollObj), lastSnapCoords.y),
        ...
        for (var i = currentIteration + primaryDirection; i < l && i >= 0; i = i + primaryDirection) {
            ...
            return {
                y: stayInBounds(0, getScrollHeight(scrollObj), adjustForPadding(snapCoords.y, pTop)),
        ...
        if (primaryDirection == 1 && i === l - 1) {
            ...
            // the for loop stopped at the last element
            return {
                y: stayInBounds(0, getScrollHeight(scrollObj), snapCoords.y),
        ...
        return {
            y: stayInBounds(0, getScrollHeight(scrollObj), adjustForPadding(obj.snapElements[currentIteration].snapCoords.y, pTop)),
